...
window.onload=function(){
	const sawons=[
		...
		{sabun:2,name:'심청이',dept:'영업부',loc:'경기',job:'과장'},
		{sabun:3,name:'박문수',dept:'감찰부',loc:'인천',job:'차장'},
		{sabun:4,name:'이순신',dept:'기획부',loc:'부산',job:'대리'},
		{sabun:5,name:'강감찬',dept:'총무부',loc:'대전',job:'부장'}
	]
	let html='';
	// for(SawonVO vo:list)

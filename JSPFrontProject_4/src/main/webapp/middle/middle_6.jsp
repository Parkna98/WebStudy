...
<%--
		...
		=> 함수 유형 : 리턴형을 기술하지 않는다 => 리턴은 가능 => 데이터형이 let,const밖에 없어서 기술하지않음
					 리턴형 메소드명(매개변수,매개변수,...)
			...
			===================================
				리턴형 		매개변수 => 리턴형은 let,const로 통일하기 때문에 기술하지 않는다
				 O			  O
				 ===============
				 ex) function func_name(id,pwd) => 데이터형 없이 변수명만 작성한다
				 	 {
				 	  	return 값;
				 	 }
				 ...
				 X		 	  O
				 ===============
				 ex) function func_name(name){
				 		return; => 생략가능 (return까지 안써도됨 => void)
				 	 }
	 	 ...
	 	 호출 방법
		 	...
		 	let func_name2=function(name){} ==> func_name2('홍길동')
		 	let func_name3=(name)=>{} ==> func_name3('홍길동')
 --%>
<!DOCTYPE html>
<html>
<head>

            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./mainpage.html"><img src="img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="staylist.jsp">상품</a></li>
                            <li><a href="#">예약</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="staylist.jsp">동반숙소</a></li>
                                    <li><a href="./shoping-cart.html">병원</a></li>
                                    <li><a href="./checkout.html">장례식장</a></li>

...
public class GoodsVO {
	...
	private String goods_sub,price,goods_name,goods_price,goods_first,goods_delivery,goods_poster;
	...
	public String getGoods_first() {
		return goods_first;
	}
	public void setGoods_first(String goods_first) {
		this.goods_first = goods_first;
	}

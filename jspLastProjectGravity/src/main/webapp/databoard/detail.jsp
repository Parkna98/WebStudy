...
<div class="wrapper row3">
  <main class="container clear">
   ...
   <div class="row row1" style="height: 500px; width: 800px; margin: 0px auto">
     <table class="table">
       <tr>
       ...
       <tr>
       	<td colspan="4" class="text-right">
       	  ...
       	  <span class="btn btn-danger btn-xs" id="delete">삭제</span>
       	  <a href="../databoard/list.do" class="btn btn-info btn-xs">목록</a>
       	</td>
       </tr>
       <tr id="del" style="display:none">
         <td colspan="4" class="text-right inline">
           비밀번호:<input type="password" id=pwd class="input-sm">
           <input type="button" value="삭제" id="delBtn" data-no="${vo.no }" class="btn btn-sm btn-danger">
         </td>
       </tr>
     </table>
   </div>

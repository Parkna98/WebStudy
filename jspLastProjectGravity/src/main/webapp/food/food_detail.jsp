	  ...
	  <main class="container clear">
	    ...
	    <table class="table">
	      <td width="40%" class="text-center" rowspan="8">
	        <img style="width: 100%" src="${vo.poster }" id="poster">
	      </td>
	      <td colspan="2">
	    ...
	    <c:if test="${sessionScope.id!=null }">
	     <table class="table">
	       <tr>
	         <td>
	           <form method="post">
	             <textarea rows="4" cols="48" style="float: left;"></textarea>
	             <input type="submit" value="댓글 쓰기" class="btn btn-sm btn-danger" style="height: 85px; float: left">
	           </form>
	         </td>
	       </tr>
	     </table>

...
/*
		1. 관련된 클래스가 여러개 있다 => interface 통합
		2. 조건문 없이 사용 => Map
		3. 미리 클래스 메모리 할당 => 주소
		   ================== 싱글턴
		...
		5. 구분
		   ...
		   => ex) 새글작성,수정,삭제 => request를 보낼 필요가 없어서 sendRedirect
		   =>     목록출력,상세보기 등 => request를 필요로 하기 때문에 forward
...
public class Controller extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 		/JSPMVCProject_2/delete.do ===> URI
		 		=================
		 		ContextPath
		 		=> ContextPath의 다음부터 .전까지 자름
		 */

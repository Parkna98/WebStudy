...
public class BoardModel {
	...
	public String board_insertok(HttpServletRequest request,HttpServletResponse response) {
	...
	public void board_deleteok(HttpServletRequest request,HttpServletResponse response) {
		String no=request.getParameter("no");
		String pwd=request.getParameter("pwd");
		BoardDAO dao=BoardDAO.newInstance();
	...
	// 수정
	   ...
	   public String board_update(HttpServletRequest request,HttpServletResponse response)
	   {
	      String no=request.getParameter("no");
	      BoardDAO dao=BoardDAO.newInstance();
	      BoardVO vo=dao.boardInfoData(Integer.parseInt(no), 2); // type번호 2번. 조회수 증가 안되게
	      request.setAttribute("vo", vo);

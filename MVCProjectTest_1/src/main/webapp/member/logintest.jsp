...
<div class="login-page">
  <div class="header__logo">
       <a href="#"><h2>PETSTIVAL<img src="../img/mainlogo.png" width="35px" height="35px"></h2></a>
  </div>
  <div class="form">
    <form class="login-form">
      <input type="text" placeholder="ID를 입력하세요" id="logid" name="logid"/>
      <input type="password" placeholder="비밀번호를 입력하세요" id="logpwdname" name="logpwd"/>
      <button>로그인</button>

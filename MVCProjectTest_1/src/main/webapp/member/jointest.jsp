...
<div class="join_container">  
  <form id="contact" action="../member/join_ok.do" name="joinFrm" method="post">
    ...
    <h4>아래 양식을 작성해주세요</h4>
    <fieldset>
      <input name="id" id="id" class="writeid" placeholder="ID 입력" type="text" tabindex="1" style="float:left;" autofocus>
    ...
    <fieldset>
      <input name="post" id="post" class="writepost" placeholder="우편번호" type="text" tabindex="9" style="float:left;">
      <button class="postnum" name="postnum" type="button" id="contact-post" style="float: left">우편번호검색</button>
    </fieldset>
    <fieldset>
      <input name="addr1" id="addr1" placeholder="주소" type="text" tabindex="10">
    </fieldset>
    <fieldset>

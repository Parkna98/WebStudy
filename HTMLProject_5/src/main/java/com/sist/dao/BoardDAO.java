...
public class BoardDAO {
	...
	/*
		...
		1. 미리 Connection 객체를 생성
			=> 몇개 => maxIdle=10
		2. 연결되어 있는 Connection의 주소값을 얻어온다
		3. Connection을 사용
		4. 반드시 사용후에는 반환 
				=> new를 사용하면 Connection이 늘어나므로 이방식은 Connection을 관리할 수 있다는 장점 
		=================================================================================
		1. 보안이 뛰어나다
	...
	public void getConnection() {
		try {
			// 저장시에 => 탐색기 형식으로 메모리 주소를 저장 JNDI (Java Naming Directory Index)

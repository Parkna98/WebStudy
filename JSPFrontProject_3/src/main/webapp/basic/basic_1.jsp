...
/*
		...
		2) 데이터형 (자바스크립트에서 지원)
		   ...
		   ========================
			   Boolean(1) => true, Boolean(0) => false ==> 0만 false, 이외의 모든 숫자 true
		   	   ===> C언어
		   ...
		   =======> 데이터형이 달라고 된다 ["aaa",10,10.5,true...]
			 *** 
		     ...
		     let i=function(){}
		     => Number(정수,실수), String(문자,문자열), Boolean
...
window.onload=function(){
	...
	*/	 
		 ...
		 */
		 ...
		 let m; // 값이 없는 경우 / 선언안된 변수 ===> undefined
